...
import {CARD_WIDTH} from '../../marketplace/item-card/item-card-loader/item-card-loader.component';
...
export class WatchlistComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.userService.getWatchlistProducts().pipe(untilDestroyed(this)).subscribe((watchlist) => {
  ...
  private subscribeToRemoval() {
    this.userService.selectWatchlistIds().pipe(skip(1), untilDestroyed(this)).subscribe((ids) => {
